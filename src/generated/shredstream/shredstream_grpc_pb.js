...
var shredstream_pb = require('./shredstream_pb.js');
var google_protobuf_timestamp_pb = require('google-protobuf/google/protobuf/timestamp_pb.js');

function serialize_shredstream_Entry(arg) {
  if (!(arg instanceof shredstream_pb.Entry)) {
...
function deserialize_shredstream_Entry(buffer_arg) {
  return shredstream_pb.Entry.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_shredstream_Fill(arg) {
  if (!(arg instanceof shredstream_pb.Fill)) {
...
function deserialize_shredstream_Fill(buffer_arg) {
  return shredstream_pb.Fill.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_shredstream_PumpCreate(arg) {
  if (!(arg instanceof shredstream_pb.PumpCreate)) {
...
function deserialize_shredstream_PumpCreate(buffer_arg) {
  return shredstream_pb.PumpCreate.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_shredstream_SubscribeEntriesRequest(arg) {
  if (!(arg instanceof shredstream_pb.SubscribeEntriesRequest)) {
...
function deserialize_shredstream_SubscribeEntriesRequest(buffer_arg) {
  return shredstream_pb.SubscribeEntriesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_shredstream_SubscribeFillsRequest(arg) {
  if (!(arg instanceof shredstream_pb.SubscribeFillsRequest)) {
...
function deserialize_shredstream_SubscribeFillsRequest(buffer_arg) {
  return shredstream_pb.SubscribeFillsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_shredstream_SubscribePumpCreatesRequest(arg) {
  if (!(arg instanceof shredstream_pb.SubscribePumpCreatesRequest)) {
...
function deserialize_shredstream_SubscribePumpCreatesRequest(buffer_arg) {
  return shredstream_pb.SubscribePumpCreatesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var ShredstreamProxyService = exports.ShredstreamProxyService = {
  subscribeEntries: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: shredstream_pb.SubscribeEntriesRequest,
    responseType: shredstream_pb.Entry,
...
subscribePumpCreates: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: shredstream_pb.SubscribePumpCreatesRequest,
    responseType: shredstream_pb.PumpCreate,
...
subscribeFills: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: shredstream_pb.SubscribeFillsRequest,
    responseType: shredstream_pb.Fill,
